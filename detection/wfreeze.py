...
"""
    Tensorflow graph freezing script for Windows
    Argumentparser arguments:
    *model_dir - directory to export model to. Current working directory by default.
...
def freeze_graph(model_dir, output_node_names):
    ...
    output_graph = absolute_model_dir + "\\frozen_model_windows.pb"
